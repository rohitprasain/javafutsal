...
public class chooseDoctor extends javax.swing.JFrame {
    ...
    public chooseDoctor() {
        ...
        Object columns[] = { "Joining Date", "Id", "Name", "Age", "Gender", "Blood Group", "Department", "Phone Number", "Email Address", "Status", "Address", "Room number", "Username"};
    ...
    private void initComponents() {
        ...
        dSearchbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Department","General Physical", "Dental", "Gynaecology", "Opthalmology","Dermatology","Orthopaedic" }));
        ...
        dASearchbtn1.setBackground(new java.awt.Color(102, 0, 102));
    ...
    private void jLabel19MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel19MouseClicked
        AdminActivity appoint = new AdminActivity();
    ...
    private void dASearchbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtnMouseClicked
        ...
        String sql = "select date,id,name,age,gender,blood,dept,phone,email,status,address,room,username from doctor where dept = '" + searchKey + "'";
        try {
