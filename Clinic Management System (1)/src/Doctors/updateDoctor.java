...
public class updateDoctor extends javax.swing.JFrame {
    ...
    public void loadData() {
        ...
        String sql = "select date,id,name,age,gender,blood,dept,phone,email,status,address,room,username,password from doctor";
        try {
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update doctor set date = '" + date + "', id = '" + id + "', name = '" + name + "', age = '" + age + "', gender = '" + gender + "', blood = '" + blood + "', dept = '" + dept + "', phone = '" + phone + "', email = '" + email + "', status = '" + status + "', address = '" + address + "', room = '" + room + "', username = '" + username + "', password = '" + password + "' where id = '" + id + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
