...
public class updatePatient extends javax.swing.JFrame {
    ...
    public updatePatient() {
        ...
        Object columns[] = { "Id","Date", "Name", "Age", "Gender", "Address", "Phone Number", "Status", "Disease"};
    ...
    public void loadData() {
        ...
        String sql = "select date,id,name,age,gender,address,phone,status,disease from patient";
        try {
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update patient set date = '" + date + "', name = '" + name + "', age = '" + age + "', gender = '" + gender + "', address = '" + address + "', phone = '" + phone + "', status = '" + status + "', disease = '" + disease + "' where id = '" + id + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
